...
const GUIDANCE = Object.freeze([
  {
    id: 'spawn-orient',
    afterMs: 2500,
    caption: 'Site identity is behind you. Turn, read the board, then walk into the plant.',
    voice: 'Site identity is behind you. Turn, read the board, then walk into the plant.',
  },
  {
    id: 'enter-plant',
    afterMs: 14000,
    caption: 'Move toward the orange process piping. Look for wet staining at flange joints.',
    voice: 'Move toward the orange process piping. Look for wet staining at flange joints.',
    unlessInspected: ['flange-leak'],
  },
  {
    id: 'inspect-flange',
    afterMs: 28000,
    caption: 'Inspect the leaking flange. Record evidence, return to the equipment, then FIX in the field.',
  ...
  },
  {
    id: 'broaden-walkdown',
    afterMs: 52000,
    caption: 'Continue the walkdown: supports, electrical entry, drain route, access path, and temporary connections.',
  ...
  },
  {
    id: 'monitor-review',
    afterMs: 90000,
    caption: 'Untreated findings escalate over time. Monitor and review is continuous — not a closing checkbox.',
    voice: 'Untreated findings escalate over time. Monitor and review is continuous, not a closing checkbox.',
  },
]);
