export const scenario = {
  ...
  stages: [
    ...
    },
    {
      name: 'Treat',
      type: 'portfolio',
      prompt: 'You have 20 minutes of immediate pre-start response capacity. Build the strongest control portfolio. Long repairs can follow, but startup can be held.',
      feedback:
        'The strongest immediate portfolio acts on each risk pathway: isolate the leak, protect the drain, clear access, lock out the electrical circuit, and hold startup pending support repair. Together these actions use 19 minutes.',
    },
    {
      name: 'Monitor & Review',
