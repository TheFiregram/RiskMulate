...
function createTempHose(THREE, scene, materials) {
  ...
  addCylinder(THREE, root, 0.055, 1.05, hoseMat, [0, 0.42, -0.45], 'z', 10);
  addCylinder(THREE, root, 0.055, 0.85, hoseMat, [-0.05, 0.55, 0.2], 'z', 10);
  addCylinder(THREE, root, 0.055, 0.7, hoseMat, [-0.18, 0.48, 0.7], 'z', 10);
